...
function getMultipleDataFromDB(query1, content, res, req) {
    let data1 = null;
    let data2 = null;
    return new Promise(function (resolve, reject) {
        pool.query('BEGIN');
...
async function getMultipleData(query1, content, res, req) {
    await getMultipleDataFromDB(query1, content, res, req);
}
