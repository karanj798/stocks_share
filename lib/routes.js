...
module.exports = function (app) {
    ...
    app.get('/stats', (req, res) => {
        if (req.isAuthenticated()) {
            ...
            //let data1 = getData(query1, req, res);
            //let data2 = getData(query2, req, res);
...
function getMultipleDataFromDB(query1, query2, req, res, viewName) {
    let data1 = null;
    let data2 = null;
    return new Promise(function (resolve, reject) {
        pool.query('BEGIN');
        ...
        JSON.stringify(pool.query(query2, (err, result) => {
            if (err) {
                res.json({
                    "Response": "Error fetching data.",
                    "Error": err
